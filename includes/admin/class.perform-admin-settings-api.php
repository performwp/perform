...
/**
 * Perform_Admin_Settings_API.
 *
 * WP Settings API Class.
 *
 * @since 1.0.0
 */
if ( ! class_exists( 'Perform_Admin_Settings_API' ) ) :
		...
		public function navigation_html() {
            ...
            <h2 class="nav-tab-wrapper">
				...
				foreach ( $this->sections_array as $tab ) {
					...
					?>
                    <a href="?page=perform-for-wordpress&tab=<?php echo $tab['id']; ?>" class="nav-tab <?php echo $active_class; ?>">
						<?php echo $tab['title']; ?>
                    </a>
					<?php
				}
